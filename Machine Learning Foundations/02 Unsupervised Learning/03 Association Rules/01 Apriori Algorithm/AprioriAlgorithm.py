...
# Apriori Algorithm
# This script demonstrates the Apriori algorithm for association rule mining.
...
plt.title('Apriori: Association Rules (Size and Color by Lift)')
plt.grid(True)
plt.savefig('apriori_rules.png')
plt.close()